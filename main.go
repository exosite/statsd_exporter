...
func main() {
	var (
		...
		statsdListenUDP      = kingpin.Flag("statsd.listen-udp", "The UDP address on which to receive statsd metric lines. \"\" disables it.").Default(":9125").OverrideDefaultFromEnvar("UDP_PORT").String()
